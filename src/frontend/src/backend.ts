...
export class Backend implements backendInterface {
    ...
    async getTimetable(): Promise<Array<Lesson>> {
        if (this.processError) {
            try {
    ...
    async removeLesson(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeLesson(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setTimetable(arg0: Array<Lesson>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setTimetable(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateLesson(arg0: Lesson): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateLesson(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
